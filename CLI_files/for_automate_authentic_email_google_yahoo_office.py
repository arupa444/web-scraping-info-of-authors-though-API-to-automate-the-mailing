...
def send_email(subjectForEmail, sender_email, sender_password, recipient_name, recipient_email, journal, article_title, smtp_server, smtp_port, template):
...
if __name__ == "__main__":
    ...
    results = process_csv_and_send_emails(subjectForEmail, csv_file, sender_email, sender_password, smtp_server, smtp_port, template_path, max_emails, delay)
